...
# ============================================
# 🆕 RECIBO CESTATICKET HTML (100% COMPLETO - RESTAURADO)
# ============================================
...
# ============================================
# 🆕 RECIBO DE NÓMINA HTML (RESTAURADO AL 100%)
# ============================================
...
# ============================================
# 🔥 RUTA UNIFICADA PARA VER Y ELIMINAR LOTE DE NÓMINA (SOLUCIÓN AL ERROR 500)
# ============================================
@app.route('/api/lotes/<int:id>', methods=['GET', 'DELETE'])
@login_required
def manejar_lote(id):
    # ------------------------
    # SI ES UN GET (VER DETALLE) - CÓDIGO 100% COMPLETO
    # ------------------------
    if request.method == 'GET':
        try:
            conn = get_db_connection()
    ...
    # ------------------------
    # SI ES UN DELETE (ELIMINAR) - CÓDIGO 100% COMPLETO
    # ------------------------
    elif request.method == 'DELETE':
        conn = get_db_connection()
        if not conn: return jsonify({'error': 'Error de conexión'}), 500
